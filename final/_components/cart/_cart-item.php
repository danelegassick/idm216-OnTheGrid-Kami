...
if (isset($row['meal_name'])) {
    echo $row['meal_image'] . ' ' . $row['meal_name'] . ' ' . $row['meal_price'] . '<br>';
}
if (isset($row['side_name'])) {
    echo $row['side_image'] . ' ' . $row['side_name'] . ' ' . $row['side_price'] . '<br>';
}
if (isset($row['drink_name'])) {
    echo $row['drink_image'] . ' ' . $row['drink_name'] . ' ' . $row['drink_price'] . '<br>';
}
if (isset($row['protein_name'])) {
    echo $row['protein_name'] . ' ' . $row['protein_price'] . '<br>';
}
if (isset($row['restrictions_name'])) {
    echo $row['restrictions_name'] . '<br>';
}
if (isset($row['spice_level'])) {
    echo $row['spice_level'] . '<br>';
}
